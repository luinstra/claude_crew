---
name: gradle
description: Use for ANY Gradle build work. Triggers: modifying build.gradle.kts, settings.gradle.kts, or libs.versions.toml; adding/removing/bumping dependency versions; Gradle version catalogs (adding libraries, bundles, or plugins to the catalog); regenerating/fixing lockfiles; configuring Gradle tasks like test, compile, or custom tasks (JVM args, parallelism, heap size); troubleshooting build failures related to dependencies or stale lockfiles; running/writing ./gradlew commands. Activate on version catalogs, dependency management in Kotlin/JVM projects, lockfile errors, Gradle task configuration, toml-based dependency definitions, moving hardcoded dependency versions into a version catalog, creating dependency bundles, or "lockfile out of date" errors.
---
